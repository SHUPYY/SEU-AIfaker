...
class InSwapper(BaseSwapper):
    def __init__(self, name="inswapper", root="weights/models"):
        _, model_file = download_file(
            get_model_url(name), save_dir=root, overwrite=False
        )
        ...
        ), "The output number of inswapper model should be 1, but got {}, please check your model.".format(
